...
static void SeedData(List<Product> products)
{
    ...
    {
        new Product { Id = 1, Name = "Product A", Price = "$1.99" },
        new Product { Id = 2, Name = "Product B", Price = "$2.99" },
        new Product { Id = 3, Name = "Product C", Price = "$3.99" },
        new Product { Id = 4, Name = "Product D", Price = "$4.99" },
        new Product { Id = 5, Name = "Product E", Price = "$5.99" },
        new Product { Id = 6, Name = "Product F", Price = "$6.99" },
    });
}